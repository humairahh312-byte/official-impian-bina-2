...
function HomePage() {
  ...
  return (
    <>
{/* Hero */}
      <section className="relative w-full min-h-[85vh] flex flex-col justify-end pt-40 pb-24 md:pb-32 overflow-hidden border-b border-foreground/5">
        {/* Background Image */}
        <img
          src={heroImg}
          alt="Concrete and steel rebar construction site"
        ...
        {/* Foreground Content */}
        <div className="max-w-7xl mx-auto px-6 w-full relative z-20 fade-in-up">
